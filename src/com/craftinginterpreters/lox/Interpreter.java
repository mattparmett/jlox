...
class Interpreter implements Expr.Visitor<Object>,
    ...
    public Void visitClassStmt(Stmt.Class stmt) {
        ...
        // Define "super" to refer to this class's superclass
        ...
        // Pop environment that contains definition of "super"
        if (superclass != null) {
    ...
    public Object visitSuperExpr(Expr.Super expr) {
        ...
        // "this" should refer to the current class instance, not the superclass.
        // The current class instance ("this") is always defined in the environment
        // just inside of the environment where "super" is defined.
